...
parser.add_argument('--company_query', type=str, help='Comma-separated list of Company Query')
...
company_query = args.company_query.split(',') if args.company_query else []
...
full_query_name = full_query_name[:20]
if full_query_name:
